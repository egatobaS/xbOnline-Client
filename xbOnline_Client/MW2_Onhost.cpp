...
struct mw2_addr_onhost_s
{
	...
	int FallDamage_a; //0x82000858
					  ...
					  //	Scr_NotifyNum_a = 0x8224AF10; //
					  //	Scr_AddEntityNum_a = 0x8224C5C0; //
					  //									 //Scr_AddObject_a = 0x0020C480;
					  //	Scr_AddHudElem_a = 0x82209660; //
					  //	Scr_GetSelf_a = 0x82243758; //
					  //	scrVarGlob_t_a = 0x83373B80; //
					  //	GetVariableValueAddress_a = 0x82243D90; //
					  //	Scr_AddInt_a = 0x8224C348; //
					  //	Scr_AddBool_a = 0x8224C2C8; //
					  //	Scr_AddFloat_a = 0x8224C3C8; //
					  //	Scr_AddString_a = 0x8224C620; //
					  //	Scr_AddEntity_a = 0x822094E8; //
					  //	Scr_AddVector_a = 0x8224C7C8; //
					  //	Scr_AddUndefined_a = 0x8224C4C8; //
					  //	Scr_AddConstString_a = 0x8224C740; //
					  //	Scr_ClearOutParams_a = 0x82249DF0;
					  //	AngleVectors_a = 0x8228ED50; //
					  //	vectoangles_a = 0x82289930; //
					  //	SV_ExecuteClientCommand_a = 0x82253140; //
					  //	G_Spawn_a = 0x8220DB50; //
					  //	G_SpawnHelicopter_a = 0x82315E68; //
					  //	G_SetOrigin_a = 0x8220E0D8; //
					  //	G_SetAngles_a = 0x8220E130; //
					  //	G_EntLinkTo_a = 0x82212228; //
					  //	GSC_Earthquake_a = 0x821F5198; //
					  //	scrVmPub_t_a = 0x835C49D8; //
					  //	FindVariable_a = 0x82243B60; //
					  //	GetValueType_a = 0x82244290; //
					  //	FindEntityId_a = 0x82244438; //
					  //	Scr_GetEntityIdRef_a = 0x82244870; //
					  //	GetArraySize_a = 0x82243EF0; //
					  //	G_LocationalTrace_a = 0x821E76F8; //
					  //	G_SetModel_a = 0x8220D278; //
					  //	G_LocalizedStringIndex_a = 0x8220C7A0; //
					  //	G_MaterialIndex_a = 0x8220C960; //
					  //	G_GivePlayerWeapon_a = 0x82210B30; //
					  //	G_GetWeaponIndexForName_a = 0x822105A8; //
					  //	G_InitializeAmmo_a = 0x821D4968; //
					  //	G_GetPlayerViewOrigin_a = 0x821D38C8; //
					  //	Menu_PaintAll_a = 0x82285E98; //
					  //	va_a = 0x822A7028; //
					  //	Dvar_FindMalleableVar_a = 0x8229ED20; //
					  //	Dvar_GetBool_a = 0x8229EEE8; //
					  //	Dvar_GetString_a = 0x8229F0A8; //
					  //	Scr_Notify_a = 0x8229F0A8; //
					  //	SL_GetString_a = 0x82242250; //
					  //	SL_ConvertToString_a = 0x82241898; //
					  //	SV_SendServerCommand_a = 0x82257948; //
					  //										 //Scr_GetEntityId_a = 0x00000000;
					  //	GetArrayVariable_a = 0x82245BD0; //
					  //	GetVariable_a = 0x82245CC0;
					  //	//Scr_GetObjectField_a = 0x00000000;
					  //	VM_Notify_a = 0x8224A9A0; //
					  //	Cmd_RegisterNotification_a = 0x82225858; //
					  //	irand_a = 0x8220E3D8; //
					  //	BG_TakePlayerWeapon_a = 0x82210990; //
					  //	BG_GetWeaponName_a = 0x820E22F0; //
					  //	Cbuf_AddText_a = 0x82224990; //
					  //	G_ModelIndex_a = 0x8220CA40; //
					  //	GScr_Earthquake_a = 0x821F5198; //
					  //	GScr_MagicBullet_a = 0x821FD9E0; //
					  //	ClientThink_Real_a = 0x821D1A90; //
					  //	player_die_a = 0x821DCDC8; //
					  //	ScrCmd_Attach_a = 0x821F55D0; //
					  //	SP_Script_Model_a = 0x82206D88; //
					  //	SV_UnlinkEntity_a = 0x8225F430; //
					  //	SV_LinkEntity_a = 0x8225F518; //
					  //	SV_SetBrushModel_a = 0x82254B50; //
					  //	G_EffectIndex_a = 0x8220CE48; //
					  //	Scr_PlayFX_a = 0x821FB7C0; //
					  //	ScrCmd_LinkTo_a = 0x821F6338; //
					  //	ScriptEntCmd_RotateTo_a = 0x82207568; //
					  //	GScr_Spawn_a = 0x821F5438; //
					  //	G_CallSpawnEntity_a = 0x82209348; //
					  //	Scr_SetString_a = 0x82242A48; //
					  //	ScriptEntCmd_CloneBrushModelToScriptModel_a = 0x82208140; //
					  //	ScriptEntCmd_rotateyaw_a = 0x82207A28; //
					  //	SV_DObjGetBoneIndex_a = 0x82255278; //
					  //	G_FindConfigstringIndex_a = 0x8220C6A8; //
					  //	G_AddEvent_a = 0x8220E038; //
					  //	PlayerCmd_cloneplayer_a = 0x821DAAF0; //
					  //	G_SpawnPlayerClone_a = 0x8220ED40; //
					  //	G_SoundAliasIndex_a = 0x8220CFB0; //
					  //	Dvar_GetInt_a = 0x8229EF50; //
					  //	Dvar_GetFloat_a = 0x8229EFB8; //
					  //	SV_AddTestClient_a = 0x82254690; //
					  //	SetClientViewAngle_a = 0x821D3550; //
					  //	G_Damage_a = 0x821DD3D8; //
					  //	HudElem_DestroyAll_a = 0x821DFA58; //
					  //	G_SpawnTurret_a = 0x822198F8; //
					  //	GScr_PlayerLinkTo_a = 0x821F68A0; //
					  //	ScrCmd_Unlink_a = 0x821F6348; //
					  //	ScriptEntCmd_MoveTo_a = 0x82206FC0; //
					  //	GScr_LoadMap_a = 0x82201518; //
					  //	G_RadiusDamage_a = 0x821DE418; //
					  //	G_EntUnlink_a = 0x82211170; //
					  //	SV_KickClient_a = 0x82251610; //
					  //	SV_SetConfigString_a = 0x82256840; //
					  //	SuperJump_a = 0x82001A34; //
					  //	SuperSpeed_a = 0x821D1DE0; //
					  //	FallDamage_a = 0x82019C48; //
					  //}
};
